...
import {frontProjects} from '@/src/app/api/route'
  ...
  //& the animation logic
    useEffect(() => {
      const ctx = gsap.context(() => {
        ...
        const totalScrollDistance = projects.length * projectScrollDistance;
    ...
    <div id='pin' ref={containerRef} className='w-full flex flex-col gap-5 '>
      ...
      <div className='mb-[20px] py-5 flex-center md:gap-[100px] gap-[20px] w-full backdrop-blur-xl '>
        ...
        <Link href={`/${locale}/projects`}>
          <IconicBtn text={"All Projects"} icon={<FaProjectDiagram />} iconStyle={" text-text "} buttonColors={"bg-stone-400/10 shadow-lg shadow-stone-500/10 btn backdrop-blur-6xl text-orange-500 px-8 "} />
        </Link>
